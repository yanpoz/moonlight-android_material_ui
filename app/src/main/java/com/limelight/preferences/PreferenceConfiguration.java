...
public class PreferenceConfiguration {
    ...
    public static final String LEGACY_ENABLE_51_SURROUND_PREF_STRING = "checkbox_51_surround";
    ...
    public static final String SHOW_GUIDE_BUTTON_PREF_STRING = "checkbox_show_guide_button";
    ...
    public static final String DYNAMIC_THEME_PREF_STRING = "checkbox_dynamic_theme";
    ...
    public static final boolean DEFAULT_HOST_AUDIO = false;
    public static final int DEFAULT_DEADZONE = 7;
    public static final int DEFAULT_OPACITY = 90;
    public static final String DEFAULT_LANGUAGE = "default";
    public static final boolean DEFAULT_MULTI_CONTROLLER = true;
    public static final boolean DEFAULT_USB_DRIVER = true;
    public static final String DEFAULT_VIDEO_FORMAT = "auto";

    public static final boolean ONSCREEN_CONTROLLER_DEFAULT = false;
    public static final boolean ONLY_L3_R3_DEFAULT = false;
    public static final boolean SHOW_GUIDE_BUTTON_DEFAULT = true;
    public static final boolean DEFAULT_ENABLE_HDR = false;
    public static final boolean DEFAULT_ENABLE_PIP = false;
    public static final boolean DEFAULT_ENABLE_PERF_OVERLAY = false;
    public static final boolean DEFAULT_BIND_ALL_USB = false;
    public static final boolean DEFAULT_MOUSE_EMULATION = true;
    public static final String DEFAULT_ANALOG_STICK_FOR_SCROLLING = "right";
    public static final boolean DEFAULT_MOUSE_NAV_BUTTONS = false;
    public static final boolean DEFAULT_UNLOCK_FPS = false;
    public static final boolean DEFAULT_VIBRATE_OSC = true;
    public static final boolean DEFAULT_VIBRATE_FALLBACK = false;
    public static final int DEFAULT_VIBRATE_FALLBACK_STRENGTH = 100;
    public static final boolean DEFAULT_FLIP_FACE_BUTTONS = false;
    public static final boolean DEFAULT_TOUCHSCREEN_TRACKPAD = true;
    public static final String DEFAULT_AUDIO_CONFIG = "2"; // Stereo
    public static final boolean DEFAULT_LATENCY_TOAST = false;
    public static final String DEFAULT_FRAME_PACING = "latency";
    public static final boolean DEFAULT_ABSOLUTE_MOUSE_MODE = false;
    public static final boolean DEFAULT_ENABLE_AUDIO_FX = false;
    public static final boolean DEFAULT_REDUCE_REFRESH_RATE = false;
    ...
    public static final boolean DEFAULT_DYNAMIC_THEME = true;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.dynamicTheme = prefs.getBoolean(DYNAMIC_THEME_PREF_STRING, DEFAULT_DYNAMIC_THEME);
